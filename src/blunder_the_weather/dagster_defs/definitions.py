...
from blunder_the_weather.dagster_defs.jobs import backfill_job, quality_checks_job, train_models_job, transform_job
...
defs = Definitions(
    ...
    jobs=[backfill_job, transform_job, quality_checks_job, train_models_job],
    resources={
